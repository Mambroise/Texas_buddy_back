...
from users.views.auth_views import VerifyRegistrationAPIView, Verify2FACodeAPIView,SetPasswordAPIView,ResendRegistrationNumberAPIView,LoginAPIView,LogoutAPIView,LogoutAllAPIView,RequestPasswordResetAPIView
...
urlpatterns = [
    ...
    path('password-reset/verify-code/', Verify2FACodeAPIView.as_view()),
